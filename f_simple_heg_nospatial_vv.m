function [t,total] = f_simple_heg_nospatial_vv(c_thetaA,c_thetaB,c_e,c_T)
% A function which solves the simple HEG Ace paper ODE model, for a
% specified value of the mean density of feeding and breeding sites
% respectively
