function dYdt = f_derivative_xshred_rainfall(t,Y,v_parameters,v_t,v_nu)
...
% Use the time to linearly interpolate the rainfall/egg laying term
t;
c_nu = interp1(v_t,v_nu,t);
